This was an assignment testing the button and switch from our plushy assignment. You set the button or switch to 0 when its off or 1 when its on and program how the 3 led's will respond. 
